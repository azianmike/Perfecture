...
import asian.mike.perfak.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class Show_single_fullscreen_image extends Activity {
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_show_single_fullscreen_image);

		Bundle extras = getIntent().getExtras();
		if (extras != null) {
		    value = extras.getString("imageName");
		    Log.i("value", value);
		}
